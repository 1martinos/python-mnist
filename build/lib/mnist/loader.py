...
class MNIST(object):
    ...
    def load_images(self):
        ims, _ = self.load(os.path.join(self.path, self.train_img_fname),
                                os.path.join(self.path, self.train_lbl_fname))
    ...
    def process_images(self, images):
        if self.return_type == 'lists':
            ...
            return self.process_images_to_tensor(images)
        else:
